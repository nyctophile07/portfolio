...
function Navbar() {
    return (
        <nav className="nav top-0 fixed max-w-fit flex justify-center items-center px-10 py-3 rounded-4xl text-white font-instrument-sans z-10 gap-9 m-6 text-lg backdrop-blur-sm cursor-pointer opacity-95">
